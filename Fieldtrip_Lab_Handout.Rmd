...
For the purposes of calculating LOD/LOQ, we want a linear calibration curve. Luckily, at low concentrations our response should be relatively linear. First, let's select the first five points for each analyte, choose an analyte, and plot it to make sure the data make sense. You may need to remove the point at concentration = 0 as well. 
